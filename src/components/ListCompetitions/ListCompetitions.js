        ...
        <Table sx={{ bgcolor: "whitesmoke", borderRadius: 5 }} aria-label="simple table">
          <TableHead>
            <TableRow sx={{ borderRadius: 5 }}>
              ...
              <TableCell align="center" sx={{ color: "black", border: 0.5, borderColor: "#282c34", fontWeight: "bold" }}>Competitors</TableCell>
              <TableCell align="center" sx={{ color: "black", border: 0.5, borderColor: "#282c34", fontWeight: "bold" }}>Results</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
